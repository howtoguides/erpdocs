...
ERPNext has several [types of reports]({{docs_base_url}}/user/manual/en/customize-erp/articles/making-custom-reports-in-erp) which can be customize as per the companies/users requirement.
