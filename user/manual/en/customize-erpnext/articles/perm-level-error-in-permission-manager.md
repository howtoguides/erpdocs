...
While customizing rules in the [Permission Manager]({{docs_base_url}}/user/erp/user/manual/en/setting-up/users-and-permissions/role-based-permissions), you might receive an error message saying:
