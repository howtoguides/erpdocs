...
![Item Price list]({{docs_base_url}}/assets/old_images/erp/item-price-list.png)
...
![Item Price Item]({{docs_base_url}}/assets/old_images/erp/item-price-item.png)

Step 3: Enter Rate

Enter selling/buying rate of an item in Price List currency.

![Item Price Rate]({{docs_base_url}}/assets/old_images/erp/item-price-rate.png)
