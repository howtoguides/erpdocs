...
1. [Bulk Renaming]({{docs_base_url}}/user/manual/en/using-erp/articles/bulk-rename.html)
2. [Document Merging]({{docs_base_url}}/user/manual/en/using-erp/articles/merging-documents.html)
